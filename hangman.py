...
>In any case you make up to 5 mistakes. Each mistake will add the next part of hangman picture.
            """)
print("")
...
print(f"FOR DEBUGGING: {chosen_word}") #FOR DEBUGGING
